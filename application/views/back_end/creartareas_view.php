    ...
    <section class="contenido">
        ...
        <fieldset>
            ...
            <form action="<?php echo base_url(); ?>backend/profesor_control/insertarea" method="post" enctype="multipart/form-data" >
                ...
                <select name='selcatedra' id='selcatedra'><?php foreach ($arrDatos as $catedra) : ?><option value="<?php echo $catedra->idcatedra ?>"><?php echo $catedra->cat_denominacion ?>
                ...
                <input type="hidden" id="aula" name="aula"  value='<?php echo $this->input->post('selaula') ?>' />
