...
<section class="contenido">
    <fieldset>
        ...
        <?php // } ?>
        <?php echo form_open("backend/adhome/insert_profesores")
        ?>
        <span id="msgUsuario"></span>
        <label name="lbl_usu_nombre">Nombre/s y Apellido/s: </label>
        <input type="text" name="username" id="username" placeholder="Nombre" required="" maxlength="30" value='<?php echo set_value('username') ?>' /><br>
        <span id="msgCedula"></span>
        <label name="lbl_usu_nrocedula">Número de C.I: </label>
        <input type="text" name="usu_nrocedula" id="usu_nrocedula" placeholder="Número de C.I" onkeypress="return justNumbers(event);" required="" maxlength="10" value='<?php echo set_value('usu_nrocedula') ?>' /><br>
        ...
        <input type="email" name="email" id="email" placeholder="Email" maxlength="30" required="" value='<?php echo set_value('email') ?>' /><br> 
...
<!--        <label name="lbl_pregunta">Pregunta Secreta: </label>
        ...
        <input type="submit" name="btnguardarplan" value="Crear Usuario" />
