    ...
    <section class="contenido">
        ...
        <fieldset>
            ...
            <form method="post">
                ...
                <label for="lbl_profesor">Profesor: </label>
                ...
                <input type="submit" name="cancelar" id="cancelar" value="Volver"  dir="<?php echo base_url(); ?>backend/inscatedras_control/listar_catedras_profesores"/>
            </form>
