...
<section class="contenido">
    ...
    $consulta = $this->db->query("select au.aul_denominacion,carreras.car_denominacion,catedras.cat_denominacion,profesor.usu_nombre
...
join usu_cate on usu_cate.idcatedra=catedras.idcatedra join usuarios as profesor on usu_cate.idusuario=profesor.idusuario
 join catedras as cate on usu_cate.idcatedra=cate.idcatedra where alumno.usu_nombre='$a';");
    $tmpl = array(
    ...
    $this->table->set_heading('Aula', 'Plan de Estudio', 'Catedra', 'Profesor');
