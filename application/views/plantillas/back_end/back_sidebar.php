<aside>
    <ul>
        ...
        <li><a href="<?php echo base_url() ?>backend/planestudio_control/success">Agregar Catedras a un Plan de Estudios</a></li>
        <li><a href="<?php echo base_url() ?>backend/carreras_control/carreras">Crear Carreras</a></li>
        <li><a href="<?php echo base_url() ?>backend/reg_aula/successaula">Crear Aulas</a></li>
