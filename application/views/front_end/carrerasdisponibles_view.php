    ...
    <section class="contenido">
        ...
        <?php if (!empty($arrDatoscarreras)) : ?>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading"><span class="glyphicon glyphicon-list" aria-hidden="true"></span><h2 style="float: center;">Lista de Carreras (Click Sobre la Carrera)</h2><span style="float: right;">Filtrar<input id="filtro" type="text" title="Reconoce Mayúsculas" data-content="Ej.: Juan, juan, JUAN..."></span></div>

                <div class="panel-content">

                    <table id="paginar" table border="1" cellpadding="2" cellspacing="1" WIDTH="100%">

                        <thead><tr><th>Carreras</th>
                        ...
                        <tbody id="filtrar">
                            <?php foreach ($arrDatoscarreras as $lis) : ?>
                                <tr>
                                    ...
                                    <td><?= anchor(base_url().'frontend/suscripcion_control/suscripcionaulas/'.$lis->id_carrera,$lis->car_denominacion)?></td>
                                <?php endforeach; ?></tr>
                        </tbody>                      
