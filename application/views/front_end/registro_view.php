...
<section class="contenido">
    <fieldset>
        ...
        <input type="hidden" id="regiscarrera" name="regiscarrera"  value='<?php echo $_POST['suscarrera'] ?>' />
        <input type="hidden" id="regisaula" name="regisaula"  value='<?php echo $_POST['susaula'] ?>' />
